...
const char* ssid = "stella";
const char* password = "adrian2025_Emb";
...
<html>
<head>
  <title>stella Systems - Smart Lighting</title>
  <style>
...
<body>
  <h2>Welcome to stella Systems - Smart Light Control</h2>
  <div>
    <p>Control LED 1:</p>
  ...
  <footer>
    &copy;  stella Systems | Team 3 Lighting Embedded Systems
  </footer>
</body>
</html>
)rawliteral";
